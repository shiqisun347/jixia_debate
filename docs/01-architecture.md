...
| 路径 | 用户 | 实现入口 | 实时频道 | 交互 |
| --- | --- | --- | --- | --- |
| `/screen` | 观众/投屏 | `apps/frontend/src/pages/ScreenPage.tsx` | screen/state/events | 只读；由管理端切场景 |
| `/console/:speakerId` | 人类辩手 | `apps/frontend/src/pages/ConsolePage.tsx` | speaker/state/events | 开始/结束本人发言、自由辩论请求 AI 队友 |
| `/admin` | 主持人/管理员 | `apps/frontend/src/pages/AdminPage.tsx` | admin/state/events | 全量控制、配置、投票、干预 |
| `/vote/:matchId` | 学生观众 | `apps/frontend/src/pages/VotePage.tsx` | REST 轮询或短连接 | 提交优胜方和最佳辩手 |
